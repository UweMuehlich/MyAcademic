...
After **making changes** in the main branch in GitHub, these changes are not visible on the website. The repository is organized as follows (you see it in Settings - Pages):
<pre>
  Deploy from a branch
  Branch: gh-pages
  Folder: /(root)
</pre>
Therefore, the following steps are necessary for updating the website:
- create pull request (base branch: **gh-pages**, Compare branch: **main**)
- merge pull request
- confirm merge

and wait for about 20 to 30 seconds for GitHub pages to rebuild.
